...
const Banner = () => {
  return (
    <div className="grid md:flex justify-between items-center p-4 container bg-indigo-100 rounded-lg">
      <div className="">
        ...
        <p className="text-lg md:text-xl font-bold text-slate-500">
          Building Bright Futures: BrainBlox, Empowering Kids Through Education
          and Exploration!
        </p>
