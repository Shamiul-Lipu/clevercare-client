        ...
        <section className="py-10">
            ...
            <div className="pb-10">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                    ...
                    {
                        courses && courses.slice(0, 6).map((course, i) => <div data-aos="zoom-out-right" key={i} className="card w-96 bg-base-100 shadow-xl">
                            ...
                            <div className="card-body">
                                ...
                                <p className="font-bold text-blue-800">Ratings: {course.rating} out of 5</p>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                    ...
                    {
                        courses && courses.slice(6, 12).map((course, i) => <div data-aos="zoom-out-left" key={i} className="card w-96 bg-base-100 shadow-xl">
                            <figure><img src={course.img} alt="Shoes" /></figure>
                            <div className="card-body">
                                <h2 className="card-title">Course: {course.course}</h2>
                                <p className="font-bold text-lg">{course.instructor}</p>
