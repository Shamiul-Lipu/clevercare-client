    ...
    <section className="pb-14">
      ...
      <div className="grid lg:grid-cols-2 gap-3 bg-slate-100">
        <div className="py-4 mx-auto">
          <h3 className="text-center text-xl pb-3 font-bold">
            Tranding Toys
            <span className="badge badge-lg mx-2 bg-lime-300 text-black font-bold">
              NEW
            </span>
          </h3>
          ...
          <div className="text-center border-2 my-5 p-2 mx-auto">
            <h2 className="text-center text-xl pb-3 font-bold">
              Generate Today's Parenting Inspiration Quote
            </h2>
        ...
        <div className="text-center mx-auto my-auto py-4">
          <div className="">
            <h3 className="text-4xl font-extrabold text-transparent bg-gradient-to-r from-blue-800 via-purple-800 to-emerald-800 bg-clip-text py-5 text-center">
              CleverCare Toys
            </h3>
            ...
            <h5 className="text-lg font-bold text-blue-900">
              Unlock Up to{" "}
              <span className="text-orange-500 text-3xl">50% Off!</span>
            </h5>
          </div>
          <div className="">
            <p className="py-2">
              <button className="btn btn-outline ">
                <FaApple className="w-5 h-5 mx-1" /> App Store
              </button>
            </p>
            <button className="btn btn-outline">
              <FaGooglePlay className="w-5 h-5 mx-1" /> Google Play
            </button>
          </div>
        </div>
      </div>
