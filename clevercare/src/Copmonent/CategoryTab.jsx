...
const CategoryTab = () => {
    ...
    return (
        <div className='py-12 px-2'>
            <h3 className="text-5xl font-extrabold text-transparent bg-gradient-to-r from-blue-800 via-purple-800 to-emerald-800 bg-clip-text py-5 text-center">Browse Products By Category</h3>
            <Tabs>
